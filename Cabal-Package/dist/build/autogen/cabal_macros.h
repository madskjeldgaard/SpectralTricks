...
/* package SpectralTricks-0.1.0.0 */
#define VERSION_SpectralTricks "0.1.0.0"
#define MIN_VERSION_SpectralTricks(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "SpectralTricks-0.1.0.0-EoV97oykzjf4v46bENa3pe"

#define CURRENT_PACKAGE_KEY "SpectralTricks-0.1.0.0-EoV97oykzjf4v46bENa3pe"
